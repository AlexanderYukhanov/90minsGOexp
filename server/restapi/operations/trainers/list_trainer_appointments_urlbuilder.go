...
func (o *ListTrainerAppointmentsURL) Build() (*url.URL, error) {
	...
	var _path = "/trainers/appointments"
...
func (o *ListTrainerAppointmentsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListTrainerAppointmentsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListTrainerAppointmentsURL")
	}
