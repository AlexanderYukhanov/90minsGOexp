...
func (m *TrainerAppointment) validateEndsAt(formats strfmt.Registry) error {
...
func (m *TrainerAppointment) validateID(formats strfmt.Registry) error {
...
func (m *TrainerAppointment) validateStartsAt(formats strfmt.Registry) error {
...
func (m *TrainerAppointment) validateUserID(formats strfmt.Registry) error {

	if swag.IsZero(m.UserID) { // not required
		return nil
	}

	if err := validate.FormatOf("user-id", "body", "uuid", m.UserID.String(), formats); err != nil {
		return err
	}
